from src.streamlit.tab_profiler import render_profiler
from src.streamlit.tab_summary import render_summary
...
from src.streamlit.tab_review import render_near_duplicate_inspector
