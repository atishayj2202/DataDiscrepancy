...
-- 4. Filter Valid Pairs based on Dynamic Proportional Threshold
...
-- 5. Graph Preparation (Bidirectional Edges)
...
BidirectionalEdges AS (
    ...
    SELECT ID AS Node, ID AS AdjacentNode FROM SourceDataPrep
),
